...
<section id="parser" class="space-y-4">
	<h2 class="text-xs uppercase tracking-widest text-slate-400">Parser</h2>

	<div class="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-3">
		<div class="grid items-start gap-3 md:grid-cols-[220px_1fr]">
			...
			<div>
				<div class="flex items-center gap-2">
					<input id="cron-input"
								 class="w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-sm text-slate-100 outline-none focus:ring-2 focus:ring-emerald-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 transition-colors"
